# record-platform-stack — P1_AZURE_REACT_DOTNETCORE_CAKE_NUGETPKGREF_MVC_MONO
...
> **Package manager note:** The default SDK-style mechanism: `<PackageReference>` items with explicit `Version` attributes directly in `RecordsApi.csproj`.
